...
import com.mycompany.sample.core.catalog.domain.CouponImpl;
...
public class CouponDaoImpl implements CouponDao {
    ...
    public Coupon readByType(Integer type) {
        Query query = em.createQuery("select coupon from com.mycompany.sample.core.catalog.domain.Coupon coupon where coupon.type=:type");
    ...
    public Coupon readByAmount(Integer amount) {
        Query query = em.createQuery("select coupon from com.mycompany.sample.core.catalog.domain.Coupon coupon where coupon.type=:amount");
