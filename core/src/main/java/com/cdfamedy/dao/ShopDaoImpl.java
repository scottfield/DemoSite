...
public class ShopDaoImpl implements ShopDao {
    ...
    public Set<Shop> readAllShop() {
        Query query = em.createQuery("SELECT shop FROM com.cdfamedy.sample.core.catalog.domain.Shop shop");
    ...
    public Shop readShopByCode(String code) {
        Query query = em.createQuery("SELECT shop FROM com.cdfamedy.sample.core.catalog.domain.Shop shop where shop.code=:code");
