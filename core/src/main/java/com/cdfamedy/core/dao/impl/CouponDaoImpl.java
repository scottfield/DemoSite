...
import com.cdfamedy.core.domain.impl.CouponImpl;
...
public class CouponDaoImpl implements CouponDao {
    ...
    public Coupon readByType(Integer type) {
        Query query = em.createNamedQuery("READ_COUPON_BY_TYPE");
    ...
    public Coupon readByAmount(Integer amount) {
        Query query = em.createNamedQuery("READ_COUPON_BY_AMOUNT");
