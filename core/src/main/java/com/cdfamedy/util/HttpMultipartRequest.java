...
public class HttpMultipartRequest {
    ...
    public static void main(String[] args) {
        ...
        stringParams.add(new String[]{"access_token", "wZnftMzcmKfNM4O1i37EWB9BE698XAMYbkselIqy5KPAkDbVUjPvsm1sJEfEbrkN0eFnTUK7XRkch2T00dyGxKosbiafSM_IsA6uG7-wzZMZOYcADACRB"});

        List<String[]> fileParams = new ArrayList<String[]>();
        fileParams.add(new String[]{"buffer", "logo", "application/jpg", "C:\\Users\\jackie\\Desktop\\logo.jpg"});
        HttpMultipartRequest req = new HttpMultipartRequest("https://api.weixin.qq.com/cgi-bin/media/uploadimg?access_token=wZnftMzcmKfNM4O1i37EWB9BE698XAMYbkselIqy5KPAkDbVUjPvsm1sJEfEbrkN0eFnTUK7XRkch2T00dyGxKosbiafSM_IsA6uG7-wzZMZOYcADACRB", stringParams, fileParams);
        try {
            ...
            if (fileParams != null) {
                for (int i = 0, num = fileParams.size(); i < num; i++) {
                    ...
                    resSB
                            ...
                            .append("\"/r/n")
                            .append("Content-Type: ")
                            .append(fileType).append("/r/n/r/n");
