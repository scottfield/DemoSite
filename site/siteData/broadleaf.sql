...
insert  into `address_shop`(`address_shop_id`,`shop_id`,`address_id`) values (4,1,301),(5,2,302),(6,2,303),(7,2,304),(8,2,305),(9,2,306),(10,3,307),(11,2,308),(12,2,309),(13,4,310),(14,4,311),(15,2,351),(16,3,401),(17,1,402),(18,3,403),(19,4,404);
...
insert  into `blc_customer_address`(`CUSTOMER_ADDRESS_ID`,`ADDRESS_NAME`,`ADDRESS_ID`,`CUSTOMER_ID`) values (103,'收货地址',404,511);
...
insert  into `blc_customer_role`(`CUSTOMER_ROLE_ID`,`CUSTOMER_ID`,`ROLE_ID`) values (1,511,1);
...
insert  into `blc_email_tracking`(`EMAIL_TRACKING_ID`,`DATE_SENT`,`EMAIL_ADDRESS`,`TYPE`) values (1,'2016-04-07 10:43:32','scottfield@qq.com',NULL),(2,'2016-04-07 10:44:14','scottfield@qq.com',NULL),(51,'2016-04-11 11:00:30','scottfield@qq.com',NULL),(52,'2016-04-11 11:03:03','scottfield@qq.com',NULL),(101,'2016-04-11 13:29:49','scottfield@qq.com',NULL),(102,'2016-04-11 14:16:45','scottfield@qq.com',NULL),(151,'2016-04-12 10:13:15','scottfield@qq.com',NULL);
...
insert  into `blc_id_generation`(`ID_TYPE`,`BATCH_SIZE`,`BATCH_START`,`ID_MIN`,`ID_MAX`,`version`) values ('org.broadleafcommerce.profile.core.domain.Customer',100,4000,NULL,NULL,40);
...
insert  into `blc_order_item_price_dtl`(`ORDER_ITEM_PRICE_DTL_ID`,`QUANTITY`,`USE_SALE_PRICE`,`ORDER_ITEM_ID`) values (901,2,1,901),(951,2,1,951),(952,1,1,952),(1001,3,1,1001),(1051,1,1,1051),(1052,2,1,1052),(1053,3,1,1053),(1054,3,1,1054),(1055,3,1,1055),(1056,2,1,1056),(1101,1,1,1101),(1151,1,1,1151),(1201,1,1,1201);
...
insert  into `customaddressimpl`(`ADDRESS_ID`) values (252),(301),(302),(303),(304),(305),(306),(307),(308),(309),(310),(311),(351),(401),(402),(403),(404);
...
insert  into `product_extend`(`PRODUCT_EXTEND_ID`,`PRODUCT_ID`,`PROMOTION_MESSAGE`,`SALES`) values (2,10101,'测试产品促销信息',11),(3,10102,'测试产品2促销信息',0),(4,10103,NULL,0);
...
insert  into `sequence_generator`(`ID_NAME`,`ID_VAL`) values ('AddressImpl',501),('AdminRoleImpl',101),('AdminUserImpl',101),('CategoryExcludedSearchFacetImpl',1000),('CategoryImpl',10100),('CategoryProductImpl',1000),('CategoryProductXrefImpl',1400),('CategorySearchFacetImpl',1050),('CategoryXrefImpl',1100),('ChallengeQuestionImpl',1000),('CrossSaleProductImpl',101),('CustomerAddressImpl',201),('CustomerRoleImpl',101),('EmailTrackingImpl',251),('FeaturedProductImpl',1050),('FieldDefinitionImpl',1000),('FieldEnumerationImpl',1000),('FieldEnumerationItemImpl',1000),('FieldGroupImpl',1000),('FieldImpl',1000),('FulfillmentGroupImpl',1151),('FulfillmentGroupItemImpl',1301),('FulfillmentOptionImpl',1000),('MediaImpl',100400),('OfferCodeImpl',1050),('OfferImpl',1000),('OfferItemCriteriaImpl',1000),('OrderImpl',1251),('OrderItemAttributeImpl',301),('OrderItemImpl',1301),('OrderItemPriceDetailImpl',1301),('OrderPaymentImpl',251),('PageFieldImpl',1000),('PageImpl',1000),('PageTemplateImpl',1000),('PaymentTransactionImpl',251),('PersonalMessageImpl',151),('PhoneImpl',501),('ProductAttributeImpl',1200),('ProductImpl',10200),('ProductOptionImpl',1050),('ProductOptionValueImpl',1050),('ProductOptionXrefImpl',1150),('RoleImpl',1000),('SandBoxImpl',151),('SandBoxManagementImpl',151),('SearchFacetImpl',1000),('SearchFacetRangeImpl',1000),('SearchInterceptImpl',1000),('SkuAttributeImpl',101),('SkuImpl',10300),('StaticAssetImpl',100100),('StructuredContentFieldImpl',1000),('StructuredContentImpl',1000),('StructuredContentRuleImpl',1000),('StructuredContentTypeImpl',1000),('SystemPropertyImpl',101),('UpSaleProductImpl',101),('URLHandlerImpl',1000);
