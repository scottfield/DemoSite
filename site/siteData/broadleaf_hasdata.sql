...
MySQL - 5.7.12-log : Database - broadleaf
*********************************************************************
*/
...
insert  into `blc_category_product_xref`(`CATEGORY_PRODUCT_ID`,`DISPLAY_ORDER`,`CATEGORY_ID`,`PRODUCT_ID`) values (1500,NULL,2001,10300),(1501,NULL,2001,10301),(1502,NULL,2001,10302);
...
insert  into `blc_customer`(`CUSTOMER_ID`,`CREATED_BY`,`DATE_CREATED`,`DATE_UPDATED`,`UPDATED_BY`,`CHALLENGE_ANSWER`,`DEACTIVATED`,`EMAIL_ADDRESS`,`FIRST_NAME`,`LAST_NAME`,`PASSWORD`,`PASSWORD_CHANGE_REQUIRED`,`IS_PREVIEW`,`RECEIVE_EMAIL`,`IS_REGISTERED`,`TAX_EXEMPTION_CODE`,`USER_NAME`,`CHALLENGE_QUESTION_ID`,`LOCALE_CODE`) values (8600,0,'2016-05-04 21:01:58',NULL,NULL,NULL,0,'default','布矮矮儿','o1Py0twT_6kpQRqIX4rJiQD_fjvQ','o1Py0twT_6kpQRqIX4rJiQD_fjvQ{8600}',0,NULL,1,1,NULL,'o1Py0twT_6kpQRqIX4rJiQD_fjvQ',NULL,NULL);
...
insert  into `blc_customer_attribute`(`CUSTOMER_ATTR_ID`,`NAME`,`VALUE`,`CUSTOMER_ID`) values (2301,'country','中国',8600),(2302,'unionid','ocaz-ssewvtw-wspaylKRHwLejrY',8600),(2303,'subscribe','1',8600),(2304,'city','成都',8600),(2305,'openid','o1Py0twT_6kpQRqIX4rJiQD_fjvQ',8600),(2306,'sex','1',8600),(2307,'groupid','0',8600),(2308,'language','zh_CN',8600),(2309,'remark','',8600),(2310,'subscribe_time','1462349375',8600),(2311,'province','四川',8600),(2312,'P2PData',NULL,8600),(2313,'nickname','布矮矮儿',8600),(2314,'headimgurl','http://wx.qlogo.cn/mmopen/P8cRnwrPJuGKEICxMN8FRpnW4iakzOcE1a30PWFSpeyIUVGpaM1WTia136BeMqNne6fp2iahyJJ5HMQVogrHJJMgAQXSW2icLlZv/0',8600);
...
insert  into `blc_customer_role`(`CUSTOMER_ROLE_ID`,`CUSTOMER_ID`,`ROLE_ID`) values (2401,8600,1);
...
insert  into `blc_id_generation`(`ID_TYPE`,`BATCH_SIZE`,`BATCH_START`,`ID_MIN`,`ID_MAX`,`version`) values ('org.broadleafcommerce.profile.core.domain.Customer',100,8700,NULL,NULL,87);
...
insert  into `blc_media`(`MEDIA_ID`,`ALT_TEXT`,`TAGS`,`TITLE`,`URL`) values (99951,'happy乐','happy乐','happy乐','/cmsstatic/category/99951/in_21-11.png'),(100150,'撒欢儿吃','撒欢儿吃','撒欢儿吃','/cmsstatic/category/2002/in_21.png'),(100151,'可劲儿喝','可劲儿喝','可劲儿喝','/cmsstatic/category/2003/in_21-09.png'),(100152,'放开玩儿','放开玩儿','放开玩儿','/cmsstatic/category/2004/in_21-10.png'),(100200,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Skull.jpg'),(100500,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Close.jpg'),(100502,NULL,NULL,NULL,'/cmsstatic/img/sauces/Day-of-the-Dead-Habanero-Hot-Sauce-Close.jpg'),(100503,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Bottle.jpg');
...
insert  into `blc_sku_media_map`(`BLC_SKU_SKU_ID`,`MEDIA_ID`,`MAP_KEY`) values (10100,100200,'primary'),(10400,100500,'primary'),(10401,100502,'primary'),(10402,100503,'primary');
...
insert  into `customer_extend`(`customer_id`,`test`) values (8600,NULL);
...
insert  into `product_extend`(`PRODUCT_EXTEND_ID`,`PRODUCT_ID`,`PROMOTION_MESSAGE`,`SALES`,`sale_limit`,`product_department`,`product_style`,`product_sku`) values (5,10300,'快来买哦',0,1,'测试部门','dkddk','kdkdkdf'),(6,10301,'再不买就没啦',0,NULL,'测试部门','dsakdk','dkdk'),(7,10302,'卖完了就没得啦',0,12,'测试部门','sdakfjdka','eeefdee');
...
insert  into `sequence_generator`(`ID_NAME`,`ID_VAL`) values ('AddressImpl',2701),('AdminRoleImpl',101),('AdminUserImpl',101),('CategoryExcludedSearchFacetImpl',1000),('CategoryImpl',10100),('CategoryProductImpl',1000),('CategoryProductXrefImpl',1600),('CategorySearchFacetImpl',1050),('CategoryXrefImpl',1100),('ChallengeQuestionImpl',1000),('CrossSaleProductImpl',101),('CustomerAddressImpl',2051),('CustomerAttributeImpl',2401),('CustomerRoleImpl',2501),('EmailTrackingImpl',2651),('FeaturedProductImpl',1050),('FieldDefinitionImpl',1000),('FieldEnumerationImpl',1000),('FieldEnumerationItemImpl',1000),('FieldGroupImpl',1000),('FieldImpl',1000),('FulfillmentGroupImpl',2901),('FulfillmentGroupItemImpl',3051),('FulfillmentOptionImpl',1000),('MediaImpl',100600),('OfferCodeImpl',1050),('OfferImpl',1000),('OfferItemCriteriaImpl',1000),('OrderAttributeImpl',301),('OrderImpl',3051),('OrderItemAttributeImpl',301),('OrderItemImpl',3051),('OrderItemPriceDetailImpl',3051),('OrderPaymentImpl',251),('PageFieldImpl',1000),('PageImpl',1000),('PageTemplateImpl',1000),('PaymentTransactionImpl',251),('PersonalMessageImpl',151),('PhoneImpl',2251),('ProductAttributeImpl',1200),('ProductImpl',10400),('ProductOptionImpl',1050),('ProductOptionValueImpl',1050),('ProductOptionXrefImpl',1150),('RoleImpl',1000),('SandBoxImpl',151),('SandBoxManagementImpl',151),('SearchFacetImpl',1000),('SearchFacetRangeImpl',1000),('SearchInterceptImpl',1000),('SkuAttributeImpl',101),('SkuImpl',10500),('StaticAssetImpl',100100),('StructuredContentFieldImpl',1000),('StructuredContentImpl',1000),('StructuredContentRuleImpl',1000),('StructuredContentTypeImpl',1000),('SystemPropertyImpl',101),('UpSaleProductImpl',101),('URLHandlerImpl',1000);
