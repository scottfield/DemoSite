...
insert  into `address_shop`(`id`,`shop_id`,`address_id`) values (34,3,951),(35,4,1001),(36,3,1051),(37,52,1101),(38,50,1102),(39,49,1151),(40,47,1201),(41,59,1251),(42,57,1303),(43,45,1351),(44,43,1401),(45,55,1451),(46,42,1501);
...
insert  into `blc_address`(`ADDRESS_ID`,`ADDRESS_LINE1`,`ADDRESS_LINE2`,`ADDRESS_LINE3`,`CITY`,`COMPANY_NAME`,`COUNTY`,`EMAIL_ADDRESS`,`FAX`,`FIRST_NAME`,`IS_ACTIVE`,`IS_BUSINESS`,`IS_DEFAULT`,`LAST_NAME`,`POSTAL_CODE`,`PRIMARY_PHONE`,`SECONDARY_PHONE`,`STANDARDIZED`,`TOKENIZED_ADDRESS`,`VERIFICATION_LEVEL`,`ZIP_FOUR`,`COUNTRY`,`PHONE_FAX_ID`,`PHONE_PRIMARY_ID`,`PHONE_SECONDARY_ID`,`STATE_PROV_REGION`) values (1451,'default',NULL,NULL,'default',NULL,NULL,NULL,NULL,'布矮矮',1,0,1,'default','default',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,1201,NULL,NULL),(1501,'default',NULL,NULL,'default',NULL,NULL,NULL,NULL,'dafad',1,0,1,'default','default',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,1251,NULL,NULL);
...
insert  into `blc_customer_address`(`CUSTOMER_ADDRESS_ID`,`ADDRESS_NAME`,`ADDRESS_ID`,`CUSTOMER_ID`) values (951,'收货地址',1451,5900),(1001,'收货地址',1501,5800);
...
insert  into `blc_customer_role`(`CUSTOMER_ROLE_ID`,`CUSTOMER_ID`,`ROLE_ID`) values (951,5800,1),(1001,5900,1);
...
insert  into `blc_id_generation`(`ID_TYPE`,`BATCH_SIZE`,`BATCH_START`,`ID_MIN`,`ID_MAX`,`version`) values ('org.broadleafcommerce.profile.core.domain.Customer',100,6000,NULL,NULL,60);
...
insert  into `blc_phone`(`PHONE_ID`,`IS_ACTIVE`,`IS_DEFAULT`,`PHONE_NUMBER`) values (1201,1,0,'122544587'),(1251,1,0,'dafda');
...
insert  into `customaddressimpl`(`ADDRESS_ID`) values (1451),(1501);
...
insert  into `customer_coupon_xref`(`customer_coupon_xref_id`,`coupon_id`,`customer_id`,`coupon_status`,`updatedOn`,`createdOn`,`shop_id`) values (50,5,5800,0,'2016-04-28 13:51:04','2016-04-28 13:51:04',NULL),(51,5,5800,1,'2016-04-28 14:56:08','2016-04-28 14:02:22',37),(54,5,5900,1,'2016-04-28 14:15:21','2016-04-28 14:14:37',37),(55,6,5800,0,'2016-04-28 14:14:40','2016-04-28 14:14:40',NULL),(56,1,5800,0,'2016-04-28 14:55:09','2016-04-28 14:55:09',NULL);
...
insert  into `customer_extend`(`customer_id`,`test`) values (5000,NULL),(5101,NULL),(5102,NULL),(5200,NULL),(5300,NULL),(5400,NULL),(5500,NULL),(5600,NULL),(5700,NULL),(5800,NULL),(5900,NULL);
...
insert  into `sequence_generator`(`ID_NAME`,`ID_VAL`) values ('AddressImpl',1601),('AdminRoleImpl',101),('AdminUserImpl',101),('CategoryExcludedSearchFacetImpl',1000),('CategoryImpl',10100),('CategoryProductImpl',1000),('CategoryProductXrefImpl',1400),('CategorySearchFacetImpl',1050),('CategoryXrefImpl',1100),('ChallengeQuestionImpl',1000),('CrossSaleProductImpl',101),('CustomerAddressImpl',1101),('CustomerAttributeImpl',1051),('CustomerRoleImpl',1101),('EmailTrackingImpl',1251),('FeaturedProductImpl',1050),('FieldDefinitionImpl',1000),('FieldEnumerationImpl',1000),('FieldEnumerationItemImpl',1000),('FieldGroupImpl',1000),('FieldImpl',1000),('FulfillmentGroupImpl',2001),('FulfillmentGroupItemImpl',2151),('FulfillmentOptionImpl',1000),('MediaImpl',100400),('OfferCodeImpl',1050),('OfferImpl',1000),('OfferItemCriteriaImpl',1000),('OrderAttributeImpl',201),('OrderImpl',2101),('OrderItemAttributeImpl',301),('OrderItemImpl',2151),('OrderItemPriceDetailImpl',2151),('OrderPaymentImpl',251),('PageFieldImpl',1000),('PageImpl',1000),('PageTemplateImpl',1000),('PaymentTransactionImpl',251),('PersonalMessageImpl',151),('PhoneImpl',1351),('ProductAttributeImpl',1200),('ProductImpl',10200),('ProductOptionImpl',1050),('ProductOptionValueImpl',1050),('ProductOptionXrefImpl',1150),('RoleImpl',1000),('SandBoxImpl',151),('SandBoxManagementImpl',151),('SearchFacetImpl',1000),('SearchFacetRangeImpl',1000),('SearchInterceptImpl',1000),('SkuAttributeImpl',101),('SkuImpl',10300),('StaticAssetImpl',100100),('StructuredContentFieldImpl',1000),('StructuredContentImpl',1000),('StructuredContentRuleImpl',1000),('StructuredContentTypeImpl',1000),('SystemPropertyImpl',101),('UpSaleProductImpl',101),('URLHandlerImpl',1000);
