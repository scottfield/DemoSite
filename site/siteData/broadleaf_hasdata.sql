...
insert  into `blc_address`(`ADDRESS_ID`,`ADDRESS_LINE1`,`ADDRESS_LINE2`,`ADDRESS_LINE3`,`CITY`,`COMPANY_NAME`,`COUNTY`,`EMAIL_ADDRESS`,`FAX`,`FIRST_NAME`,`IS_ACTIVE`,`IS_BUSINESS`,`IS_DEFAULT`,`LAST_NAME`,`POSTAL_CODE`,`PRIMARY_PHONE`,`SECONDARY_PHONE`,`STANDARDIZED`,`TOKENIZED_ADDRESS`,`VERIFICATION_LEVEL`,`ZIP_FOUR`,`COUNTRY`,`PHONE_FAX_ID`,`PHONE_PRIMARY_ID`,`PHONE_SECONDARY_ID`,`STATE_PROV_REGION`) values (2701,'default',NULL,NULL,'default',NULL,NULL,NULL,NULL,NULL,1,0,1,'default','default',NULL,NULL,0,NULL,NULL,NULL,'CA',NULL,NULL,NULL,NULL),(2702,'default',NULL,NULL,'default',NULL,NULL,NULL,NULL,NULL,1,0,0,'default','default',NULL,NULL,0,NULL,NULL,NULL,'CA',NULL,NULL,NULL,NULL),(2703,'default',NULL,NULL,'default',NULL,NULL,NULL,NULL,'dafadf',1,0,1,'default','default',NULL,NULL,0,NULL,NULL,NULL,'CA',NULL,2201,NULL,NULL);
...
insert  into `blc_category_product_xref`(`CATEGORY_PRODUCT_ID`,`DISPLAY_ORDER`,`CATEGORY_ID`,`PRODUCT_ID`) values (1500,NULL,2001,10300),(1501,NULL,2001,10301),(1502,NULL,2001,10302),(1550,NULL,2001,10350),(1551,NULL,2001,10351),(1552,'0.000000',2002,10300),(1553,'1.000000',2002,10301),(1554,'2.000000',2002,10302),(1555,'0.000000',2003,10300),(1556,'1.000000',2003,10301),(1557,'2.000000',2003,10351),(1558,'0.000000',2004,10351),(1559,'1.000000',2004,10301),(1560,'2.000000',2004,10350),(1561,'0.000000',9950,10302),(1562,'1.000000',9950,10301),(1563,'2.000000',9950,10351);
...
insert  into `blc_customer`(`CUSTOMER_ID`,`CREATED_BY`,`DATE_CREATED`,`DATE_UPDATED`,`UPDATED_BY`,`CHALLENGE_ANSWER`,`DEACTIVATED`,`EMAIL_ADDRESS`,`FIRST_NAME`,`LAST_NAME`,`PASSWORD`,`PASSWORD_CHANGE_REQUIRED`,`IS_PREVIEW`,`RECEIVE_EMAIL`,`IS_REGISTERED`,`TAX_EXEMPTION_CODE`,`USER_NAME`,`CHALLENGE_QUESTION_ID`,`LOCALE_CODE`) values (8800,0,'2016-05-05 17:36:59',NULL,NULL,NULL,0,'default','布矮矮儿','o1Py0twT_6kpQRqIX4rJiQD_fjvQ','o1Py0twT_6kpQRqIX4rJiQD_fjvQ{8800}',0,NULL,1,1,NULL,'o1Py0twT_6kpQRqIX4rJiQD_fjvQ',NULL,NULL),(8900,0,'2016-05-05 17:52:43',NULL,NULL,NULL,0,'default',' ','o1Py0tx91UJXWdtT_gD9xMdI5Rdo','o1Py0tx91UJXWdtT_gD9xMdI5Rdo{8900}',0,NULL,1,1,NULL,'o1Py0tx91UJXWdtT_gD9xMdI5Rdo',NULL,NULL);
...
insert  into `blc_customer_address`(`CUSTOMER_ADDRESS_ID`,`ADDRESS_NAME`,`ADDRESS_ID`,`CUSTOMER_ID`) values (2051,'关注门店',2701,8800),(2052,'收货地址',2702,8800),(2053,'收货地址',2703,8900);
...
insert  into `blc_customer_attribute`(`CUSTOMER_ATTR_ID`,`NAME`,`VALUE`,`CUSTOMER_ID`) values (2401,'country','中国',8800),(2402,'unionid','ocaz-ssewvtw-wspaylKRHwLejrY',8800),(2403,'subscribe','1',8800),(2404,'city','成都',8800),(2405,'openid','o1Py0twT_6kpQRqIX4rJiQD_fjvQ',8800),(2406,'sex','1',8800),(2407,'groupid','0',8800),(2408,'language','zh_CN',8800),(2409,'remark','',8800),(2410,'subscribe_time','1462349375',8800),(2411,'province','四川',8800),(2412,'P2PData',NULL,8800),(2413,'nickname','布矮矮儿',8800),(2414,'headimgurl','http://wx.qlogo.cn/mmopen/P8cRnwrPJuGKEICxMN8FRpnW4iakzOcE1a30PWFSpeyIUVGpaM1WTia136BeMqNne6fp2iahyJJ5HMQVogrHJJMgAQXSW2icLlZv/0',8800),(2451,'country',NULL,8900),(2452,'unionid','ocaz-sguoC7Z2I2wRPu-b3uojmhE',8900),(2453,'subscribe','0',8900),(2454,'city',NULL,8900),(2455,'openid','o1Py0tx91UJXWdtT_gD9xMdI5Rdo',8900),(2456,'sex','0',8900),(2457,'groupid','0',8900),(2458,'language',NULL,8900),(2459,'remark',NULL,8900),(2460,'subscribe_time','0',8900),(2461,'province',NULL,8900),(2462,'P2PData',NULL,8900),(2463,'nickname',NULL,8900),(2464,'headimgurl',NULL,8900);
...
insert  into `blc_customer_role`(`CUSTOMER_ROLE_ID`,`CUSTOMER_ID`,`ROLE_ID`) values (2501,8800,1),(2551,8900,1);
...
insert  into `blc_media`(`MEDIA_ID`,`ALT_TEXT`,`TAGS`,`TITLE`,`URL`) values (99951,'happy乐','happy乐','happy乐','/cmsstatic/category/99951/in_21-11.png'),(100150,'撒欢儿吃','撒欢儿吃','撒欢儿吃','/cmsstatic/category/2002/in_21.png'),(100151,'可劲儿喝','可劲儿喝','可劲儿喝','/cmsstatic/category/2003/in_21-09.png'),(100152,'放开玩儿','放开玩儿','放开玩儿','/cmsstatic/category/2004/in_21-10.png'),(100200,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Skull.jpg'),(100501,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Close.jpg'),(100502,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sudden-Death-Sauce-Bottle.jpg'),(100503,NULL,NULL,NULL,'/cmsstatic/img/sauces/Hoppin-Hot-Sauce-Close.jpg'),(100550,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Close.jpg'),(100551,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Bottle.jpg');
...
insert  into `blc_phone`(`PHONE_ID`,`IS_ACTIVE`,`IS_DEFAULT`,`PHONE_NUMBER`) values (2201,1,0,'243243');
...
insert  into `blc_sku_media_map`(`BLC_SKU_SKU_ID`,`MEDIA_ID`,`MAP_KEY`) values (10100,100200,'primary'),(10400,100501,'primary'),(10401,100502,'primary'),(10402,100503,'primary'),(10450,100550,'primary'),(10451,100551,'primary');
...
insert  into `customaddressimpl`(`ADDRESS_ID`) values (2701),(2702),(2703);
...
insert  into `customer_extend`(`customer_id`,`test`) values (8800,NULL),(8900,NULL);
...
insert  into `customer_fivecard_xref`(`active_date`,`create_date`,`id`,`customer_id`,`fivecard_id`,`status`,`type`,`referer`,`is_show_dialog`) values ('2016-05-05 17:51:18','2016-05-05 17:51:18',96,8800,20,1,0,NULL,NULL),('2016-05-05 17:52:58','2016-05-05 17:52:43',97,8900,58,1,1,8800,NULL);
...
insert  into `hibernate_sequence`(`next_val`) values (98);
...
CREATE TABLE `product_extend` (
  ...
  `product_sku` varchar(20) DEFAULT NULL COMMENT 'sku',
...
insert  into `product_extend`(`PRODUCT_EXTEND_ID`,`PRODUCT_ID`,`PROMOTION_MESSAGE`,`SALES`,`sale_limit`,`product_department`,`product_style`,`product_sku`) values (5,10300,'快来买啊',0,1,'测试','skdfjd','200'),(6,10301,'好吃又便宜',0,1,'测试','dksfkds','dksfk'),(7,10302,'手慢就没啦',0,12,'测试','dkafdla','地块开发的'),(8,10350,'好吃又便宜',0,1,'测','324324','dafda'),(9,10351,'打分卡的',0,2,'dafda','打发','的咖啡就看到');
...
insert  into `sequence_generator`(`ID_NAME`,`ID_VAL`) values ('AddressImpl',2801),('AdminRoleImpl',101),('AdminUserImpl',101),('CategoryExcludedSearchFacetImpl',1000),('CategoryImpl',10100),('CategoryProductImpl',1000),('CategoryProductXrefImpl',1650),('CategorySearchFacetImpl',1050),('CategoryXrefImpl',1100),('ChallengeQuestionImpl',1000),('CrossSaleProductImpl',101),('CustomerAddressImpl',2151),('CustomerAttributeImpl',2551),('CustomerRoleImpl',2651),('EmailTrackingImpl',2801),('FeaturedProductImpl',1050),('FieldDefinitionImpl',1000),('FieldEnumerationImpl',1000),('FieldEnumerationItemImpl',1000),('FieldGroupImpl',1000),('FieldImpl',1000),('FulfillmentGroupImpl',2901),('FulfillmentGroupItemImpl',3051),('FulfillmentOptionImpl',1000),('MediaImpl',100650),('OfferCodeImpl',1050),('OfferImpl',1000),('OfferItemCriteriaImpl',1000),('OrderAttributeImpl',301),('OrderImpl',3051),('OrderItemAttributeImpl',301),('OrderItemImpl',3051),('OrderItemPriceDetailImpl',3051),('OrderPaymentImpl',251),('PageFieldImpl',1000),('PageImpl',1000),('PageTemplateImpl',1000),('PaymentTransactionImpl',251),('PersonalMessageImpl',151),('PhoneImpl',2301),('ProductAttributeImpl',1200),('ProductImpl',10450),('ProductOptionImpl',1050),('ProductOptionValueImpl',1050),('ProductOptionXrefImpl',1150),('RoleImpl',1000),('SandBoxImpl',151),('SandBoxManagementImpl',151),('SearchFacetImpl',1000),('SearchFacetRangeImpl',1000),('SearchInterceptImpl',1000),('SkuAttributeImpl',101),('SkuImpl',10550),('StaticAssetImpl',100100),('StructuredContentFieldImpl',1000),('StructuredContentImpl',1000),('StructuredContentRuleImpl',1000),('StructuredContentTypeImpl',1000),('SystemPropertyImpl',101),('UpSaleProductImpl',101),('URLHandlerImpl',1000);
