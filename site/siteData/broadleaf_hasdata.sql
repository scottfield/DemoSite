...
insert  into `address_shop`(`id`,`shop_id`,`address_id`) values (34,3,951),(35,4,1001),(36,3,1051),(37,52,1101),(38,50,1102),(39,49,1151),(40,47,1201),(41,59,1251),(42,57,1303),(43,45,1351),(44,43,1401),(45,55,1451),(46,42,1501),(47,63,1551),(48,60,1601),(49,39,1651),(50,37,1701),(51,37,1702),(52,37,1703),(53,55,1751),(54,37,1801);
...
insert  into `blc_address`(`ADDRESS_ID`,`ADDRESS_LINE1`,`ADDRESS_LINE2`,`ADDRESS_LINE3`,`CITY`,`COMPANY_NAME`,`COUNTY`,`EMAIL_ADDRESS`,`FAX`,`FIRST_NAME`,`IS_ACTIVE`,`IS_BUSINESS`,`IS_DEFAULT`,`LAST_NAME`,`POSTAL_CODE`,`PRIMARY_PHONE`,`SECONDARY_PHONE`,`STANDARDIZED`,`TOKENIZED_ADDRESS`,`VERIFICATION_LEVEL`,`ZIP_FOUR`,`COUNTRY`,`PHONE_FAX_ID`,`PHONE_PRIMARY_ID`,`PHONE_SECONDARY_ID`,`STATE_PROV_REGION`) values (1801,'default',NULL,NULL,'default',NULL,NULL,NULL,NULL,NULL,1,0,1,'default','default',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `blc_customer`(`CUSTOMER_ID`,`CREATED_BY`,`DATE_CREATED`,`DATE_UPDATED`,`UPDATED_BY`,`CHALLENGE_ANSWER`,`DEACTIVATED`,`EMAIL_ADDRESS`,`FIRST_NAME`,`LAST_NAME`,`PASSWORD`,`PASSWORD_CHANGE_REQUIRED`,`IS_PREVIEW`,`RECEIVE_EMAIL`,`IS_REGISTERED`,`TAX_EXEMPTION_CODE`,`USER_NAME`,`CHALLENGE_QUESTION_ID`,`LOCALE_CODE`) values (6700,0,'2016-05-02 11:01:45',NULL,NULL,NULL,0,'default','布矮矮儿','o1Py0twT_6kpQRqIX4rJiQD_fjvQ','o1Py0twT_6kpQRqIX4rJiQD_fjvQ{6700}',0,NULL,1,1,NULL,'o1Py0twT_6kpQRqIX4rJiQD_fjvQ',NULL,NULL);
...
insert  into `blc_customer_address`(`CUSTOMER_ADDRESS_ID`,`ADDRESS_NAME`,`ADDRESS_ID`,`CUSTOMER_ID`) values (1301,'关注门店',1801,6700);
...
insert  into `blc_customer_attribute`(`CUSTOMER_ATTR_ID`,`NAME`,`VALUE`,`CUSTOMER_ID`) values (1351,'country','中国',6700),(1352,'unionid','ocaz-ssewvtw-wspaylKRHwLejrY',6700),(1353,'subscribe','1',6700),(1354,'city','成都',6700),(1355,'openid','o1Py0twT_6kpQRqIX4rJiQD_fjvQ',6700),(1356,'sex','1',6700),(1357,'groupid','0',6700),(1358,'language','zh_CN',6700),(1359,'remark','',6700),(1360,'subscribe_time','1461902348',6700),(1361,'province','四川',6700),(1362,'P2PData',NULL,6700),(1363,'nickname','布矮矮儿',6700),(1364,'headimgurl','http://wx.qlogo.cn/mmopen/P8cRnwrPJuGKEICxMN8FRpnW4iakzOcE1a30PWFSpeyIUVGpaM1WTia136BeMqNne6fp2iahyJJ5HMQVogrHJJMgAQXSW2icLlZv/0',6700);
...
insert  into `blc_customer_role`(`CUSTOMER_ROLE_ID`,`CUSTOMER_ID`,`ROLE_ID`) values (1451,6700,1);
...
insert  into `blc_id_generation`(`ID_TYPE`,`BATCH_SIZE`,`BATCH_START`,`ID_MIN`,`ID_MAX`,`version`) values ('org.broadleafcommerce.profile.core.domain.Customer',100,6800,NULL,NULL,68);
...
insert  into `customaddressimpl`(`ADDRESS_ID`) values (1801);
...
insert  into `customer_fivecard_xref`(`active_date`,`create_date`,`id`,`customer_id`,`fivecard_id`,`status`,`type`,`referer`,`is_show_dialog`) values ('2016-05-02 11:02:51','2016-05-02 11:02:47',71,6700,3,1,0,NULL,NULL);
...
insert  into `product_extend`(`PRODUCT_EXTEND_ID`,`PRODUCT_ID`,`PROMOTION_MESSAGE`,`SALES`,`sale_limit`) values (5,10150,'快来买哦！买买买',10,1),(6,10151,'测试产品2促销信息',-1,NULL),(7,10152,'测试产品3促销信息',0,NULL);
