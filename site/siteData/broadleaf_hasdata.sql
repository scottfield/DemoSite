...
insert  into `blc_category_product_xref`(`CATEGORY_PRODUCT_ID`,`DISPLAY_ORDER`,`CATEGORY_ID`,`PRODUCT_ID`) values (1350,NULL,2001,10150),(1351,NULL,2001,10151),(1352,NULL,2001,10152),(1400,NULL,2001,10200),(1450,NULL,2001,10250);
...
insert  into `blc_customer`(`CUSTOMER_ID`,`CREATED_BY`,`DATE_CREATED`,`DATE_UPDATED`,`UPDATED_BY`,`CHALLENGE_ANSWER`,`DEACTIVATED`,`EMAIL_ADDRESS`,`FIRST_NAME`,`LAST_NAME`,`PASSWORD`,`PASSWORD_CHANGE_REQUIRED`,`IS_PREVIEW`,`RECEIVE_EMAIL`,`IS_REGISTERED`,`TAX_EXEMPTION_CODE`,`USER_NAME`,`CHALLENGE_QUESTION_ID`,`LOCALE_CODE`) values (8500,0,'2016-05-04 17:43:34',NULL,NULL,NULL,0,'default','布矮矮儿','o1Py0twT_6kpQRqIX4rJiQD_fjvQ','o1Py0twT_6kpQRqIX4rJiQD_fjvQ{8500}',0,NULL,1,1,NULL,'o1Py0twT_6kpQRqIX4rJiQD_fjvQ',NULL,NULL);
...
insert  into `blc_customer_attribute`(`CUSTOMER_ATTR_ID`,`NAME`,`VALUE`,`CUSTOMER_ID`) values (2251,'country','中国',8500),(2252,'unionid','ocaz-ssewvtw-wspaylKRHwLejrY',8500),(2253,'subscribe','1',8500),(2254,'city','成都',8500),(2255,'openid','o1Py0twT_6kpQRqIX4rJiQD_fjvQ',8500),(2256,'sex','1',8500),(2257,'groupid','0',8500),(2258,'language','zh_CN',8500),(2259,'remark','',8500),(2260,'subscribe_time','1462349375',8500),(2261,'province','四川',8500),(2262,'P2PData',NULL,8500),(2263,'nickname','布矮矮儿',8500),(2264,'headimgurl','http://wx.qlogo.cn/mmopen/P8cRnwrPJuGKEICxMN8FRpnW4iakzOcE1a30PWFSpeyIUVGpaM1WTia136BeMqNne6fp2iahyJJ5HMQVogrHJJMgAQXSW2icLlZv/0',8500);
...
insert  into `blc_customer_role`(`CUSTOMER_ROLE_ID`,`CUSTOMER_ID`,`ROLE_ID`) values (2351,8500,1);
...
insert  into `blc_id_generation`(`ID_TYPE`,`BATCH_SIZE`,`BATCH_START`,`ID_MIN`,`ID_MAX`,`version`) values ('org.broadleafcommerce.profile.core.domain.Customer',100,8600,NULL,NULL,86);
...
insert  into `blc_media`(`MEDIA_ID`,`ALT_TEXT`,`TAGS`,`TITLE`,`URL`) values (99951,'happy乐','happy乐','happy乐','/cmsstatic/category/99951/in_21-11.png'),(100150,'撒欢儿吃','撒欢儿吃','撒欢儿吃','/cmsstatic/category/2002/in_21.png'),(100151,'可劲儿喝','可劲儿喝','可劲儿喝','/cmsstatic/category/2003/in_21-09.png'),(100152,'放开玩儿','放开玩儿','放开玩儿','/cmsstatic/category/2004/in_21-10.png'),(100200,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Skull.jpg'),(100350,NULL,NULL,NULL,'/cmsstatic/product/9950/ii_11.png'),(100352,NULL,NULL,NULL,'/cmsstatic/img/sauces/Green-Ghost-Close.jpg'),(100353,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Tile.jpg'),(100400,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Skull.jpg'),(100451,NULL,NULL,NULL,'/cmsstatic/img/sauces/Sweet-Death-Sauce-Close.jpg');
...
insert  into `blc_sku_media_map`(`BLC_SKU_SKU_ID`,`MEDIA_ID`,`MAP_KEY`) values (10100,100200,'primary'),(10250,100350,'primary'),(10251,100352,'primary'),(10252,100353,'primary'),(10300,100400,'primary'),(10350,100451,'primary');
...
insert  into `customer_extend`(`customer_id`,`test`) values (8500,NULL);
...
insert  into `sequence_generator`(`ID_NAME`,`ID_VAL`) values ('AddressImpl',2651),('AdminRoleImpl',101),('AdminUserImpl',101),('CategoryExcludedSearchFacetImpl',1000),('CategoryImpl',10100),('CategoryProductImpl',1000),('CategoryProductXrefImpl',1550),('CategorySearchFacetImpl',1050),('CategoryXrefImpl',1100),('ChallengeQuestionImpl',1000),('CrossSaleProductImpl',101),('CustomerAddressImpl',2001),('CustomerAttributeImpl',2351),('CustomerRoleImpl',2451),('EmailTrackingImpl',2601),('FeaturedProductImpl',1050),('FieldDefinitionImpl',1000),('FieldEnumerationImpl',1000),('FieldEnumerationItemImpl',1000),('FieldGroupImpl',1000),('FieldImpl',1000),('FulfillmentGroupImpl',2851),('FulfillmentGroupItemImpl',3001),('FulfillmentOptionImpl',1000),('MediaImpl',100550),('OfferCodeImpl',1050),('OfferImpl',1000),('OfferItemCriteriaImpl',1000),('OrderAttributeImpl',301),('OrderImpl',3001),('OrderItemAttributeImpl',301),('OrderItemImpl',3001),('OrderItemPriceDetailImpl',3001),('OrderPaymentImpl',251),('PageFieldImpl',1000),('PageImpl',1000),('PageTemplateImpl',1000),('PaymentTransactionImpl',251),('PersonalMessageImpl',151),('PhoneImpl',2201),('ProductAttributeImpl',1200),('ProductImpl',10350),('ProductOptionImpl',1050),('ProductOptionValueImpl',1050),('ProductOptionXrefImpl',1150),('RoleImpl',1000),('SandBoxImpl',151),('SandBoxManagementImpl',151),('SearchFacetImpl',1000),('SearchFacetRangeImpl',1000),('SearchInterceptImpl',1000),('SkuAttributeImpl',101),('SkuImpl',10450),('StaticAssetImpl',100100),('StructuredContentFieldImpl',1000),('StructuredContentImpl',1000),('StructuredContentRuleImpl',1000),('StructuredContentTypeImpl',1000),('SystemPropertyImpl',101),('UpSaleProductImpl',101),('URLHandlerImpl',1000);
