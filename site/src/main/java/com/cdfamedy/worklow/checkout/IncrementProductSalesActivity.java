 ...
 */
public class IncrementProductSalesActivity extends BaseActivity<ProcessContext<CheckoutSeed>> {

    protected static final Log LOG = LogFactory.getLog(IncrementProductSalesActivity.class);
